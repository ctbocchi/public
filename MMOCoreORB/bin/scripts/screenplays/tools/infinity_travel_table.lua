...
InfinityTravelTable = {
	...
	{catName = "PVP Destinations",
		subCategory = {
			"PVP Locations and Staging Areas", "pvp_staging",
		}
	},
	...
	{catName = "Mandalorian Destinations",
		subCategory = {
			"Quest Locations", "mando_points",
			"Faction Hideouts", "mando_hideouts",
		}
	},
}

InfinityTravelDestinationTable = {
	{subCatName = "port_corellia", 
		 destinations = {
			...
			"Coronet (Starport)", "corellia", -139.928, 28, -4727.78, 0,
	...
	{subCatName = "port_dantooine",
		 destinations = {
			...
			"Dantooine Imperial Outpost", "dantooine", -4210.85, 3, -2350.49, 0,
	...
	{subCatName = "port_dathomir",
		 destinations = {
			...
			"Village of Aurilia (Shuttleport)", "dathomir", 5241.5, 78.5, -4069.66, 0,
		}
	},
	{subCatName = "port_endor",
		 destinations = {
			"Endor Research Outpost (Starport)", "endor", 3202.58, 24.0, -3499.4, 0,
			"Endor Smuggler Outpost (Starport)", "endor", -952.283, 73.0, 1554.11, 0,
		}
	},
	{subCatName = "port_lok",
		 destinations = {
	...
	{subCatName = "port_naboo",
		 destinations = {
			...
			"Highgarden (Shuttleport)", "naboo", -5042.06, 8.92225, 2833.78, 0,
	...
	{subCatName = "port_talus",
		 destinations = {
			...
			"Talus Imperial Outpost", "talus", -2228.16, 20, 2320.44, 0,
		}
	},
	...
	{subCatName = "poi_corellia",
		destinations = {
			"Afarathu Cave", "corellia", -2483, 19.7852, 2907, 0,
			"Chiss Poacher Base", "corellia", 5325.3, 0.040539, 1528.03, 0,
			"Lord Nyax's Cult", "corellia", 1414, 32.3879, -317, 0,
		}
	},
	{subCatName = "poi_dantooine",
		destinations = {
			"Abandoned Rebel Base", "dantooine", -6663, 30, 5602, 0,
			"Janta Stronghold", "dantooine", 7064, 48.6429, -4097, 0,
			"Mok Stronghold", "dantooine", -7258.84, 32.8523, -3320.22, 0,
	...
	{subCatName = "poi_dathomir",
		destinations = {
			...
			"Imperial Prison", "dathomir", -6091, 128.371, 1009, 0,			
			...
			"Starship Crash Site", "dathomir", 5638, 126.168, 2000, 180,
		}
	},
	{subCatName = "poi_endor",
		destinations = {
			...
			"Korga Cave", "endor", 2272, 22.7473, 3519, 0,
		}
	},
	{subCatName = "poi_lok",
		destinations = {
			"Canyon Corsair's Stronghold", "lok", -3792, 12.1799, -3904, 0,
			"Droid Engineer's Cave", "lok", 3363.57, 78.6013, -4922.41, 0,
			"Imperial Outpost", "lok", -1685.55, 11.9431, -3070.96, 0,
			"Kimogila Town", "lok", -75.1211, 12.0, 2701.22, 0,
		}
	},
	{subCatName = "poi_naboo",
		destinations = {
			"Emperor's Retreat", "naboo", 2414.35, 292, -3943.29, 0,
			"Mauler Stronghold", "naboo", 2962.46, 93.9929, 1109.08, 0,
			"Naboo Pirate Bunker", "naboo", -1536.76, 278.955, -1680.16, 0,
			"Weapons Development Facility", "naboo", -6468.56, 38.1662, -3163.12, 0,
		}
	},
	{subCatName = "poi_rori",
		destinations = {
			"Cobral Hideout", "rori", 5464, 94.2988, 5045, 0,
			"Hyperdrive Research Facility", "rori", -1048.07, 94.5438, 4464.87, 0,
			"Varactyl Hunting Grounds", "rori", 6172, 75.7, -6585.9, 0,
			"Blacksun Hideout", "rori", 4837.0, 76.2, -1088, 0,
		}
	},
	{subCatName = "poi_talus",
		destinations = {
			"Binyare Pirate Bunker", "talus", 5526, 99.6143, -4073, 0,
			"Erran Sif's Bunker", "talus", 2142.69, 121.226, -5565.26, 0,
			"Kahmurra Biogenetic Research Station", "talus", -4729, 17.3331, -4723, 0,
	...
	{subCatName = "poi_tatooine",
		destinations = {
			...
			"Jabba's Palace", "tatooine", -5856.62, 90, -6183.29, 0,	
	...
	{subCatName = "pvp_staging",
		destinations = {
			"Dathomir PVP Event Imperial Staging Area", "dathomir", -3916.29, 128.558, 115.561, 0,
			"Dathomir PVP Event Rebel Staging Area", "dathomir", -4244.3, 126.284, -397.707, 0,
			"Endor PVP Event Imperial Staging Area", "endor", 1733.55, 12.6385, -3243.15, 0,
			"Endor PVP Event Rebel Staging Area", "endor", 1460.3, 6.26817, -2998.14, 0,
			"Lok Infinity Arena Imperial Staging Area", "lok", 903.42, 12.0724, 1944.08, 0,
			"Lok Infinity Arena Imperial (Inside Arena)", "lok", 902.205, 11.9318, 2040.42, 0,
			"Lok Infinity Arena Rebel Staging Area", "lok", 903.42, 11.6599, 2237.76, 0,
			"Lok Infinity Arena Rebel (Inside Arena)", "lok", 902.005, 11.9681, 2141.33, 0,
			"Tatooine Imperial Staging Area", "tatooine", -4309.13, 19.9396, -4312.76, 0,
			"Tatooine Rebel Staging Area", "tatooine", -4934.12, 55.4017, -4434.53, 0,
		}
	},
	{subCatName = "mando_points",
		destinations = {
			"Armorer (Mos Pelgo Mine)", "tatooine", -248.178, -59.9, -232.43, 9995631,
			"Dath, route to Dr Pershing", "dathomir", 3581, 129, 4690, 0,
			"Din Djarin (Mos Pelgo Tavern)", "tatooine", 4.81, -3.96617, -4.87, 9995742,
			"Din Djarin (Rori Bunker)", "rori", -16.3, -50.0, -0.3, 3566262,
			"Dr. Pershing (Imperial Oasis)", "tatooine", 3.44, 0.125266, 1.91667, 1289936,
			"Dr. Pershing (Dathomir Lab)", "dathomir", 14.5203, 1.01, -19.1714, 9815457,
			"Fishing Village", "yavin4", 5013, 8, 4068, 0,
			"Greef Karga (Dr. Pershing's Lab)", "dathomir", 3616, 0.1, 7160, 0,
			"Greef Karga (Greef's Pelgo Workshop)", "tatooine", 3.39437, 0.124125, -10.0237, 9995933,
			"Greef Karga (Lucky Despot Cantina)", "tatooine", 31.6151, 7.01001, 3.06794, 1076950,
			"Greef Karga (Mos Pelgo Medical Center Roof)", "tatooine", 3250.83, 35.25, 7431.66, 0,
			"Imperial Tavern", "talus", 1726.4, 22.7, 1626.1, 0,
			"Jawa Negotiator", "tatooine", 3772, 19, -5217, 0,
			"Jawa Traders", "tatooine", -6147, 6, 1851, 0,
			"Kuiil's Moisture Farm", "tatooine", -2070, 140, 7555, 0,
			"Mos Pelgo (City, No Shuttle)", "tatooine", 3051.4, 28.0, 7287.9, 0,
			"Mos Pelgo Med Center", "tatooine", 3209, 28.0, 7400, 0,			
			"Myriad City", "talus", -2815, 16.1, -5973, 0,
			"Omera", "yavin4", 5025, 9, 4425, 0,
			"Sennex Cave", "tatooine", 6549.3, 104, -1320.9, 0,
			"Warren Cantina", "dantooine", -35, -52, -104, 8575712,
			"Warren Enter NPC", "dantooine", -557, 0, -3737, 0,
		}
	},
	{subCatName = "mando_hideouts",
		destinations = {
			"Black Krrsantan (Naboo)", "naboo", -4964, 0 ,4846, 0,
			"Darkwalkers (Rori)", "rori", 3340, 0, 7398, 0,
			"Kanjiklub (Tat)", "tatooine", -7610, 0, -4868, 0,
			"Zann Consortium (Tat)", "tatooine", 6134, 0, -438, 0,
			"Guavian Death Gang (Tat)", "tatooine", -592, 0, 5448, 0,
			"Corellian Exchange (Corellia)", "corellia", -6620, 0, -3732, 0,
			"Xonti Brothers (Corellia)", "corellia", 6721, 0, -6116, 0,
			"Crymorah Syndicate", "talus", 4621, 0, 5951, 0,
			"Crimson Dawn", "dathomir", 1953, 0, 2596, 0,
			"Blacksun (Endor)", "endor", 4917, 0, -4898, 0,
			"Pyke Syndicate (Yavin 4)", "yavin4", 1524, 0, -6320, 0,
			"Kleef (Rori)", "rori", -7026, 0, -6805, 0,
		}
	},
}
