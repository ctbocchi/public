...
object_mobile_vehicle_base_shared_xj6_air_speeder = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/base/shared_xj6_air_speeder.iff"
}

ObjectTemplates:addClientTemplate(object_mobile_vehicle_base_shared_xj6_air_speeder, "object/mobile/vehicle/base/shared_xj6_air_speeder.iff")
