...
CitySpecializationCooldown = 600 -- Fix this with merge, should be in milliseconds

--The amount of time in minutes before another withdrawal from the city treasury may be made.
TreasuryWithdrawalCooldown = 600  -- Fix this with merge, should be in milliseconds
...
--The number of citizens required to achieve each city rank. (Outpost, Village, Township, City, Metropolis, Megalopolis)
